 ...
 * @property {string} [fotoCorretta] terza foto (cartella Corrected), solo con abilitaCq = 1
 * @property {string} [fotoBox]
 * @property {string} [fotO_SUPERIORE]
 * @property {string} [fotO_FRONTALE]
 * @property {string} [fotO_CORRETTA]
 ...
 * @property {boolean|null} [abilitaCqColore] seconda dimensione CQ (colore); nullable a DB
 * @property {boolean|null} [esitoCqColore]
 * @property {number|null} [scostamentoCqColore]
 ...
 * @property {boolean|null} [abilitA_CQ_COLORE]
 * @property {boolean|null} [esitO_CQ_COLORE]
 * @property {number|null} [scostamentO_CQ_COLORE]
