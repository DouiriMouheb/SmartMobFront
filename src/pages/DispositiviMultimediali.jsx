...
const DispositiviMultimediali = () => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-4">Dispositivi Multimediali</h1>
      {loading && (
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-yellow-700 mt-1">L'API per i Dispositivi Multimediali non è ancora pronta. La tabella verrà caricata automaticamente quando l'API sarà disponibile.</p>
            </div>
          </div>
        </div>
      )}
